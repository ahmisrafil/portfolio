...
const About = () => {
    return (
        <div className='lg:mx-20 mt-20 flex flex-col lg:flex-row lg:gap-36 justify-center text-white'>
            ...
            <div>
                <motion.h3 variants={aboutVariants} className='text-6xl font-semibold bg-gradient-to-l from-gray-400 via-pink-600 to-red-500 bg-clip-text text-transparent mb-8 mx-4'>ABOUT ME</motion.h3>
